...
setup(
    name='annofabcli', version=about['__version__'], description='Utility Command Line Interface for AnnoFab',
    ...
    install_requires=['annofabapi>=0.7.1', 'requests', 'pillow', 'pyyaml',
                      'dictdiffer'], python_requires='>=3.6', classifiers=[
