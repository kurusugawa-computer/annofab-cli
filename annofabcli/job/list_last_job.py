...
class ListLastJob(CommandLine):
    ...
    def get_project_info(self, project_id: str, project: Project, add_details: bool = False) -> Dict[str, Any]:  # noqa: FBT001
        """
    ...
    def get_last_job_list(self, project_id_list: List[str], job_type: ProjectJobType, add_details: bool = False) -> List[ProjectJobInfo]:  # noqa: FBT001
        job_list = []
    ...
    def print_job_list(self, project_id_list: List[str], job_type: ProjectJobType, add_details: bool = False) -> None:  # noqa: FBT001
        """
        ジョブ一覧を出力する
