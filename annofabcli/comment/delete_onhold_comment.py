...
class DeleteOnholdComment(AbstractCommandLineInterface):
    COMMON_MESSAGE = "annofabcli comment delete_onhold: error:"
...
def main(args: argparse.Namespace):
    ...
    DeleteOnholdComment(service, facade, args).main()
...
def add_parser(subparsers: Optional[argparse._SubParsersAction] = None):
    subcommand_name = "delete_onhold"
    subcommand_help = "保留コメントを削除します。"
    description = "保留コメントを削除します。\n【注意】他人の付けた保留コメントも削除できてしまいます。"
