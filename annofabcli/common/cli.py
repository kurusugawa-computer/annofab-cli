...
from annofabapi.exceptions import NotSupportedUserError as AnnofabApiNotSupportedUserError
from annofabapi.models import OrganizationMemberRole, ProjectMemberRole
from more_itertools import first_true

from annofabcli.common.dataclasses import WaitOptions
from annofabcli.common.enums import FormatArgument
from annofabcli.common.exceptions import AnnofabCliException, AuthenticationError, NotSupportedUserError
...
def build_annofabapi_resource_and_login(args: argparse.Namespace) -> annofabapi.Resource:
    ...
    try:
        ...
        raise e
    except AnnofabApiNotSupportedUserError as e:
        raise NotSupportedUserError(service.api.login_user_id, "MFAが有効化されたユーザーはannofabcliを実行できません。") from e
