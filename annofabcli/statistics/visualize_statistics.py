...
class VisualizeStatistics(AbstractCommandLineInterface):
    ...
    def visualize_statistics(self, project_id: str, work_dir: Path, output_dir: Path, task_query: Dict[str, Any],ignored_task_id_list: List[TaskId], user_id_list: List[str]):
        """
        タスク一覧を出力する
    ...
    def main(self):
        ...
        self.visualize_statistics(args.project_id, output_dir=Path(args.output_dir), work_dir=Path(args.work_dir), task_query=task_query, ignored_task_id_list=ignored_task_id_list, user_id_list=user_id_list)
...
def parse_args(parser: argparse.ArgumentParser):
    ...
    parser.add_argument('-u', '--user_id', nargs='+',
    ...
    parser.add_argument('--ignored_task_id', nargs='+',
