...
import numpy
import pandas
from bokeh.models import CustomJS, HoverTool, LayoutDOM
from bokeh.models.widgets.inputs import Select
from bokeh.plotting import figure

from annofabcli.common.bokeh import convert_1d_figure_list_to_2d, create_pretext_from_metadata
from annofabcli.common.utils import print_csv
from annofabcli.statistics.histogram import HistogramFrequencyColumn, create_histogram_figure, get_sub_title_from_series
    ...
    def from_csv(cls, csv_file: Path, *, custom_production_volume_list: list[ProductionVolumeColumn] | None = None) -> Task:
        df = pandas.read_csv(
            ...
            dtype={
                "project_id": "string",
                "task_id": "string",
                "first_annotation_user_id": "string",
                "first_inspection_user_id": "string",
                "first_acceptance_user_id": "string",
            },
        )
        return cls(df, custom_production_volume_list=custom_production_volume_list)
