        ...
        fig_info_list = [
            ...
            },
            {
                "y_info_list": [
                    ...
                    {
                        "column": "annotation_worktime_minute/input_data_count",
                        "legend": "入力データあたり計測作業時間(教師付)",
                    },
                    {
                        "column": "inspection_worktime_minute/input_data_count",
                        "legend": "入力データあたり計測作業時間(検査)",
                    },
                    {
                        "column": "acceptance_worktime_minute/input_data_count",
                        "legend": "入力データあたり計測作業時間(受入)",
                    },
                ],
            },
            {
                "y_info_list": [
                    ...
                    {
                        "column": "annotation_worktime_minute/annotation_count",
                        "legend": "アノテーションあたり計測作業時間(教師付)",
                    },
                    {
                        "column": "inspection_worktime_minute/annotation_count",
                        "legend": "アノテーションあたり計測作業時間(検査)",
                    },
                    {
                        "column": "acceptance_worktime_minute/annotation_count",
