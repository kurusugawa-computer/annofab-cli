...
class ListUser(CommandLine):
    ...
    def get_all_project_members(self, project_id: str, include_inactive: bool = False):  # noqa: ANN201, FBT001
        query_params = {}
        if include_inactive:
    ...
    def get_project_members_with_project_id(self, project_id_list: List[str], include_inactive: bool = False) -> List[ProjectMember]:  # noqa: FBT001
