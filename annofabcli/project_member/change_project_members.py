...
class ChangeProjectMembers(AbstractCommandLineInterface):
    ...
    def change_project_members(self, project_id: str, user_id_list, member_role: Optional[ProjectMemberRole] = None,
    ...
    def main(self):
        ...
        self.change_project_members(args.project_id, user_id_list=user_id_list, member_role=member_role,
