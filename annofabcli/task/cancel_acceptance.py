...
class CancelAcceptanceMain(CommandLineWithConfirm):
    def __init__(self, service: annofabapi.Resource, project_id: str, all_yes: bool = False) -> None:  # noqa: FBT001
    ...
    def cancel_acceptance_for_task(
        ...
        assign_last_acceptor: bool = True,  # noqa: FBT001
        task_query: Optional[TaskQuery] = None,
        task_index: Optional[int] = None,
        dryrun: bool = False,  # noqa: FBT001
    ) -> bool:
