...
.. warning::
    ...
    このコマンドは非推奨です。代わりに :doc:`create_inspection` コマンドを使用してください。

    ``comment put_inspection`` コマンドは2027/04/01以降に廃止予定です。
