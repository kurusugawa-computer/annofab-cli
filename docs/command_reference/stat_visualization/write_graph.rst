...
.. code-block::
    ...
    ├── line-graph
    │   ├── 教師付者用
    │   │   ├── 折れ線-横軸_教師付開始日-縦軸_生産量単位の指標-教師付者用.html
    │   │   └── 累積折れ線-横軸_生産量-教師付者用.html
    │   ├── 検査者用
    │   │   ├── 折れ線-横軸_検査開始日-縦軸_生産量単位の指標-検査者用.html
    │   │   └── 累積折れ線-横軸_生産量-検査者用.html
    │   ├── 受入者用
    │   │   ├── 折れ線-横軸_受入開始日-縦軸_生産量単位の指標-受入者用.html
...
``累積折れ線-横軸_生産量-*.html`` では、生産量種別をセレクトボックスで切り替えられます。
また、``折れ線-横軸_*開始日-縦軸_生産量単位の指標-*者用.html`` でも、生産量種別をセレクトボックスで切り替えられます。
