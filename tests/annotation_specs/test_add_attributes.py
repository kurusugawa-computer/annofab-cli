...
class TestAddAttributesMain:
    ...
    def test_add_attributes__duplicated_input_attribute_name(self, annotation_specs: dict) -> None:
        ...
        with pytest.raises(ValueError):
            main.add_attributes(
                attribute_inputs=[
                    AttributeInput(attribute_type=AttributeType.FLAG, attribute_name_en="weather_checked", label_name_ens=["car"]),
                    AttributeInput(attribute_type=AttributeType.TEXT, attribute_name_en="weather_checked", label_name_ens=["bus"]),
                ]
            )
    ...
    def test_add_attributes__duplicated_input_attribute_id(self, annotation_specs: dict) -> None:
        ...
        with pytest.raises(ValueError):
            main.add_attributes(
                attribute_inputs=[
                    AttributeInput(attribute_type=AttributeType.FLAG, attribute_name_en="weather_checked", attribute_id="dup_id", label_name_ens=["car"]),
                    AttributeInput(attribute_type=AttributeType.TEXT, attribute_name_en="note2", attribute_id="dup_id", label_name_ens=["bus"]),
                ]
            )
    ...
    def test_add_attributes__duplicated_existing_attribute_name(self, annotation_specs: dict) -> None:
        ...
        with pytest.raises(ValueError):
            main.add_attributes(
                attribute_inputs=[
                    AttributeInput(attribute_type=AttributeType.COMMENT, attribute_name_en="comment", label_name_ens=["car"]),
                ]
            )
    ...
    def test_add_attributes__confirm_no(self, annotation_specs: dict) -> None:
        ...
        result = main.add_attributes(
            attribute_inputs=[
                AttributeInput(attribute_type=AttributeType.FLAG, attribute_name_en="weather_checked", label_name_ens=["car"]),
                AttributeInput(attribute_type=AttributeType.TEXT, attribute_name_en="note2", label_name_ens=["bus"]),
            ]
        )
